...
//	  	WebDriver driver = new ChromeDriver();
	...
	//	driver = new ChromeDriver();
		...
		//driver.get("https://stage.wholefoodsmarket.com/shop/xox/2570/27349");
		
	//	driver.findElement(By.xpath("//span[@class='price ng-binding']"));
...
/* Cature screeen		
		...
		System.out.println("Begin to take screen");
		...
		try
		{
			...
			//FileUtils.copyFile(src, new File("/Users/rameshdhanekula/Desktop/error.png"));
			//FileUtils.copyFile(src, new File("/Users/rameshdhanekula/Desktop/"+System.currentTimeMillis()+".png"));
		}
		catch(IOException e) {
		...
		//String dateee = new SimpleDateFormat("mm/dd/yy").format(new Date());
		System.out.println(new SimpleDateFormat("MMddyyyy").format(new Date()));
...
Capture screens */
	...
	//	sh.clickCategory("Browse All Catalog A");
