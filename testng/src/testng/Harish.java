...
//		String homePage = "https://www.amazon.com/wholefoodsapp/app/v1/content/sales-view/10036.html";
//        String url = "";
...
//        int respCode = 200;
	...
	//	d.get("http://www.365bywholefoods.com");
		...
		Thread.sleep(2000);
		//d.get("https://www.amazon.com/wholefoodsapp/app/v1/content/sales-view/10036.html");
		driver.get("file:///Users/rameshdhanekula/Downloads/HiddenAuth/signin.html");
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("//*[@id='emailInputSignin']")).sendKeys("harish.sriramula@wholefoods.com");
		driver.findElement(By.xpath("//*[@id='passwordInputSignin']")).sendKeys("@abcABC5");
		driver.findElement(By.xpath("//*[@id='signinForm']/input[3]")).click();
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("//*[@id='tokenText']")).click();
		
		Thread.sleep(2000);
		
		System.out.println(d.findElement(By.xpath("//*[@id='tokenText']")).getText());
		
		Thread.sleep(2000);
		
//        JavascriptExecutor js =(JavascriptExecutor)d;
//        js.executeScript("buildPrimePage();");
//        Thread.sleep(2000);
//        
...
//        {
//            System.out.println("Console log found in Test- ");
