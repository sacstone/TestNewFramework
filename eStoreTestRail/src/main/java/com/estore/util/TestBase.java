...
public class TestBase {
	...
	@BeforeSuite
	public void beforeSuite() throws FileNotFoundException, IOException, APIException {
		
		testConfig = new Properties();
		testConfig.load(new FileInputStream("TestConfig.properties"));
		
//		if (testConfig.getProperty("baseUrl").equals("https://stage.wholefoodsmarket.com/shop/xox/")){
