...
public class TaxedItem extends TestBase {
	...
	//Added for testrail	
	String testCaseID = "165253";
	long getTestRunIdRail3;
	String testResult;
/////////////////
	@Test(description = "Test case for Taxed Item")
	public void taxedItem() throws ParseException, InterruptedException, MalformedURLException, IOException, APIException {
...
//Added for testrail
		String ord = confirm.getOrderNumber();
////
