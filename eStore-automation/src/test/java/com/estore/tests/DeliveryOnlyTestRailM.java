...
public class DeliveryOnlyTestRailM extends TestBase {
	...
	public String testCaseID ="164204";
	String folder_name;
	DateFormat df;
...
*/		
	...
	//	System.out.println("The Amazon URL IS" + getAmazonURL());
		//publishresults(publish,TestComment,TestRunIdRail,getAmazonURL());
		
		

	}
	
	public void publishresults (int publish2, String Comment, long getTestRunIdRail, String AmazonUrl) throws MalformedURLException, IOException, APIException, InterruptedException{
